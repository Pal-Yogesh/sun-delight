      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-brand-light/70 font-body text-sm leading-relaxed max-w-xs">
              Freshly Baked Happiness in Every Bite. Elegant cookies for
          ...
          {/* Links 1 */}
          <div>
            <h4 className="text-lg font-bold text-white mb-6 uppercase tracking-wider text-sm">
              Our Page
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-primary hover:text-white transition-colors duration-200"
              >
                <Facebook size={18} />
              </Link>
              <Link
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-brand-light/50 text-sm font-body">
            Copyright © {new Date().getFullYear()} Sun Delight. All rights
            reserved.
          </p>
