      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <p className="text-[10px] text-brand-dark/70 font-semibold uppercase tracking-wider">
                  Natural
                </p>
              </div>
            </motion.div>
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              What they say <br />
              <span className="text-brand-primary line-through decoration-4 decoration-brand-secondary mr-2">
                about our
              </span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-accent"></span>{" "}
              cookies.
            </motion.h2>
            ...
            >
              We believe that a cookie is more than just a treat; it's an
              experience. Our master bakers blend traditional techniques with
              innovative flavors to create masterpieces that delight the senses.
            </motion.p>
