    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, #c05621 1.5px, transparent 1.5px)",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-24">
          ...
          <div className="lg:w-1/2 flex flex-col z-10" ref={textContainerRef}>
            ...
            <p className="reveal-text text-lg text-[#9c6644] leading-relaxed mb-6 lg:mb-10 border-l-4 border-[#c05621] pl-6">
              Sun Delight is a proud FMCG venture of the Suntek Group. With deep
              roots in industrial excellence, we bring our forward-looking
              vision into the fast-moving consumer goods space, beginning with
              biscuits crafted for everyday delight.
            </p>
                  ...
                  {activeTab === 0 ? (
                    ...
                    >
                      ...
                      <p>
                        ...
                        that combine traditional taste with modern manufacturing
                        excellence.{" "}
                      </p>
                      <p>Built on the trusted legacy of Suntek Group</p>
                      <blockquote className="italic font-bold text-[#c05621] border-l-2 border-[#c05621] pl-4 my-2">
                        "Every bite, a little sunshine."
                      </blockquote>
                      <p>
                        Sundelight aims to deliver products that families can
                        enjoy every day.
                      </p>
                    </motion.div>
                  ) : (
                    ...
                    >
                      ...
                      <p>
                        ...
                        This is one of North India&apos;s leading manufacturing
                        companies with decades of industrial expertise and a
                        strong reputation for quality and reliability.
                      </p>
                      <ul className="list-disc pl-5 space-y-1">
                        <li>
                          With Sundelight, the group enters with FMCG sector.
                        </li>
                        <li>
                          With the same commitment to excellence that has
                          defined its journey
                        </li>
                      </ul>
                    </motion.div>
            ...
            <Link href="/product">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="reveal-text cursor-pointer mt-6 self-start group relative overflow-hidden inline-flex items-center gap-3 px-8 py-4 rounded-full text-white font-bold text-sm tracking-wide uppercase shadow-lg shadow-[#c05621]/20"
                style={{
            ...
            <div className="absolute inset-0 z-20 pointer-events-none">
              {highlights.map((item, i) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="text-[#3d1f00] font-bold text-sm font-['Playfair_Display']">
                      {item.title}
                    </h4>
                    <p className="text-[#9c6644] text-[10px] uppercase tracking-wider">
                      {item.desc}
                    </p>
                  </div>
                </div>
