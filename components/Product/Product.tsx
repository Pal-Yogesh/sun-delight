...
const SD: Product[] = [
  {
    ...
    img: "/buiscuit2/1.png",
    name: "Butter Biscuit",
    tagline: "Golden, Buttery & Irresistible",
    badge: "BESTSELLER",
    badgeBg: "linear-gradient(135deg,#c05621,#ed8936)",
    chip: "🧈 Pure Butter",
  ...
  },
  {
    ...
    img: "/buiscuit2/2.png",
    name: "Cream Biscuit",
    tagline: "Soft Centre, Crisp Shell",
    badge: "POPULAR",
    badgeBg: "linear-gradient(135deg,#ed8936,#f5c842)",
  ...
  },
  {
    ...
    tagline: "Double Chocolate Decadence",
    badge: "FAVOURITE",
    badgeBg: "linear-gradient(135deg,#3d1f00,#6b3a1f)",
    chip: "🍫 Belgian Cocoa",
...
function Toast({ show }: { show: boolean }) {
  return (
    ...
    >
      ...
      <div>
        <div className="font-bold text-[.95rem]">
          Sun Delight — Get In Touch
        </div>
        <div className="text-[.78rem] opacity-70">
          📍 Pitam Pura, New Delhi · Open 7AM – 9PM Daily
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          "transform .5s cubic-bezier(.22,1,.36,1), box-shadow .5s, border-color .3s",
    ...
    >
      ...
      <div className="h-[240px] rounded-t-[28px] relative overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          <div
            className="relative z-[3] transition-transform duration-500 group-hover:-translate-y-4 group-hover:scale-110 w-[160px] h-[160px]"
          ...
          <div className="absolute inset-0 pointer-events-none z-[4] overflow-hidden">
            <div
              className="absolute inset-0 -skew-x-12 -translate-x-full group-hover:translate-x-[200%] transition-transform duration-500"
              style={{
                background:
      ...
      {/* Badge */}
      <div
        className="absolute top-[14px] right-[14px] z-[6] px-3 py-1 rounded-full text-[.6rem] font-extrabold text-white uppercase tracking-widest transition-transform duration-300 -rotate-6 group-hover:rotate-0 group-hover:scale-110"
        style={{
      ...
      {/* Body */}
      <div className="p-6">
        <div className="font-serif font-black text-[1.25rem] text-[#3d1f00] mb-1 leading-tight">
          {p.name}
        </div>
        <div className="text-[.72rem] italic font-serif text-[#ed8936] mb-2 opacity-90">
          {p.tagline}
        </div>
        <div className="text-[.83rem] text-[#9c6644] leading-relaxed mb-4">
          {p.desc.slice(0, 108)}…
        </div>
        <div className="flex gap-2 flex-wrap mb-5">
          <span className="inline-flex items-center gap-1 bg-orange-50 border border-orange-200/60 px-3 py-1 rounded-full text-[.65rem] font-semibold text-[#6b3a1f]">
            📦 {p.skus[0].p}
          </span>
          <span className="inline-flex items-center gap-1 bg-orange-50 border border-orange-200/60 px-3 py-1 rounded-full text-[.65rem] font-semibold text-[#6b3a1f]">
            ⚖️ {p.skus[0].w}
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            style={{
              ...
              boxShadow: "0 6px 20px rgba(192,86,33,.38)",
            }}
            onClick={(e) => {
              e.stopPropagation();
              onContact();
...
function Modal({
  ...
  return (
    ...
    >
      <div
        className="bg-[#fffdf9] rounded-[34px] w-full max-w-[800px] max-h-[92vh] overflow-hidden flex flex-col"
        style={{
          boxShadow:
            "0 50px 140px rgba(0,0,0,.42), 0 0 0 1px rgba(245,166,35,.14)",
        }}
      >
        {/* Hero */}
        <div
          className="h-[260px] sm:h-[290px] shrink-0 relative overflow-hidden flex items-center justify-center"
        ...
        >
          ...
          <div
            className="relative z-[3] w-[180px] h-[180px] sm:w-[210px] sm:h-[210px]"
            style={{
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-[5] flex-wrap justify-center">
            {product.skus.map((s, i) => (
              <div
                key={i}
                className="px-4 py-1 rounded-full bg-white/90 backdrop-blur-md border border-orange-200/50 text-[.64rem] font-bold text-[#c05621] uppercase tracking-widest whitespace-nowrap"
              >
                {s.s}: {s.w}
              </div>
            ))}
        ...
        <div className="p-6 sm:p-8 overflow-y-auto flex-1">
          <div className="font-serif font-black text-[1.8rem] sm:text-[2.1rem] text-[#3d1f00] mb-1 leading-tight">
            {product.name}
          </div>
          <div className="text-[.84rem] italic font-serif text-[#ed8936] mb-4 opacity-90">
            {product.tagline}
          </div>
          <hr
            className="border-none h-px mb-4"
            style={{
              background:
                "linear-gradient(90deg,rgba(245,166,35,.3),transparent)",
            }}
          />
          <p className="text-[.93rem] text-[#6b3a1f] leading-relaxed mb-6">
            {product.desc}
          </p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {product.feats.map((f, i) => (
              <span
                key={i}
                className="inline-flex items-center gap-1 bg-orange-50 border border-orange-200/50 px-4 py-1.5 rounded-full text-[.72rem] font-semibold text-[#6b3a1f]"
              >
                {f}
              </span>
            ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-7">
            {product.skus.map((s, i) => (
              <div
                key={i}
                className="rounded-[18px] p-4 text-center border border-orange-200/40 hover:-translate-y-1 transition-transform"
                style={{
                  background:
                    "linear-gradient(145deg,rgba(245,166,35,.06),rgba(192,86,33,.04))",
                }}
              >
                <div className="text-[.62rem] font-extrabold uppercase tracking-widest text-[#9c6644] mb-2">
                  Pack Size
                </div>
                <div className="font-serif font-black text-[1.5rem] text-[#c05621] leading-none mb-1">
                  {s.s.replace("SKU ", "")}
                </div>
                <div className="text-[.78rem] font-bold text-[#3d1f00] mb-1">
                  {s.w}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1.4fr_1fr] gap-3">
            <button
              ...
              style={{
                background: "linear-gradient(135deg,#c05621,#ed8936)",
                boxShadow: "0 8px 26px rgba(192,86,33,.42)",
              }}
              onClick={onContact}
            >
              📞 Contact Us to Order
...
export default function Product() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <div
        className="relative overflow-hidden text-center py-20 lg:py-28"
        style={{
          background: "linear-gradient(150deg,#fffdf9,#fff8f0 50%,#fef3e2)",
        }}
      >
        {/* Dots */}
        <div
          className="absolute inset-[-15%] opacity-40 pointer-events-none"
          style={{
            backgroundImage:
              "radial-gradient(circle,rgba(192,86,33,.11) 1px,transparent 1px)",
            backgroundSize: "36px 36px",
            animation: "dotDrift 18s ease-in-out infinite alternate",
          }}
        />
        {/* Orbs */}
        <div
          className="absolute top-[-18%] right-[-6%] w-[58vw] h-[58vw] rounded-full pointer-events-none"
          style={{
            background:
              "radial-gradient(circle,rgba(245,166,35,.08),transparent 65%)",
            animation: "pulse 9s ease-in-out infinite",
          }}
        />
        <div
          className="absolute bottom-[-12%] left-[-8%] w-[45vw] h-[45vw] rounded-full pointer-events-none"
          style={{
            background:
              "radial-gradient(circle,rgba(192,86,33,.07),transparent 65%)",
        ...
        <div className="relative z-10 px-6">
          <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-orange-300/40 bg-orange-50/60 backdrop-blur-md mb-6">
            ...
            <span className="text-[.68rem] font-extrabold tracking-[.22em] uppercase text-[#c05621]">
              Our Product Range
            </span>
            <span
              className="inline-block"
          ...
          <h1
            className="font-serif font-black text-[#3d1f00] leading-tight mb-4"
            style={{
              fontSize: "clamp(2.4rem,5.5vw,5.2rem)",
              letterSpacing: "-.02em",
            }}
          >
            <em className="text-[#c05621] italic">Biscuits</em>
            <br />
            Crafted With Love
          </h1>
          <p className="text-[#9c6644] text-base leading-relaxed max-w-[490px] lg:max-w-[580px] mx-auto mb-10">
            Every Sundelight biscuit is carefully crafted using high-quality
            ingredients and baked using advanced technology to ensure consistent
            taste and freshness. <br />
            From crunchy cookies to classic tea biscuits, our products are
            designed to delight every palate.{" "}
          </p>

          {/* Brand tabs */}
          <div
            className="inline-flex gap-1 p-1.5 rounded-[18px]"
            style={{ background: "rgba(61,31,0,.08)" }}
          >
            <button
      ...
      >
        <div
          className="absolute inset-[-10%] opacity-35 pointer-events-none"
          style={{
            backgroundImage:
              "radial-gradient(circle,rgba(192,86,33,.07) 1px,transparent 1px)",
        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div
                  className="w-9 h-0.5 rounded"
                  style={{
                    background: isSd
                      ? "linear-gradient(90deg,#c05621,transparent)"
                      : "linear-gradient(90deg,#1a5c2a,transparent)",
                  }}
                />
                <span
                  className="text-[.68rem] font-extrabold tracking-[.22em] uppercase"
                  style={{ color: isSd ? "#c05621" : "#1a5c2a" }}
                >
                  {isSd ? "Sun Delight Collection" : "Sunzo Collection"}
                </span>
                <span
                  className="px-3 py-0.5 rounded-full text-[.65rem] font-bold"
                  style={{
                    background: isSd
                      ? "rgba(192,86,33,.1)"
                      : "rgba(26,92,42,.1)",
                    color: isSd ? "#c05621" : "#1a5c2a",
                  }}
                >
              ...
              <h2
                className="font-serif font-black text-[#3d1f00] leading-tight"
                style={{ fontSize: "clamp(1.6rem,3vw,2.6rem)" }}
              >
                {isSd ? (
                  <>
                    Where every{" "}
                    <em className="text-[#c05621] italic">cookie</em> is a
                    smile.
                  </>
                ) : (
                  <>
                    Fresh <em className="text-[#c05621] italic">biscuits</em>{" "}
                    for every home.
                  </>
                )}
              </h2>
              <p className="text-[.88rem] text-[#9c6644] leading-relaxed max-w-[400px] mt-2">
                {isSd
                  ? "Click any product card to see full SKU details, weights & CBB info."
                  : "Sunzo brings quality at the right price — available across SKU 5 & 10."}
              </p>
            </div>
          </div>
            ...
            {isSd ? (
              SD.map((p, i) => (
                <ProductCard
                  ...
                  index={i}
                  onOpen={(id) =>
                    setActiveProduct(SD.find((x) => x.id === id) || null)
                  }
              ...
              <div className="col-span-full text-center py-20 px-5">
                ...
                <h3 className="font-serif font-black text-[#3d1f00] text-[2rem] mb-3">
                  Sunzo Collection
                </h3>
                <p className="text-[#9c6644] text-[.95rem] max-w-[420px] mx-auto mb-6 leading-relaxed">
                  Affordable, quality biscuits available across SKU 5 and SKU 10
                  packs — crafted for every home. Contact us for bulk orders and
                ...
                <div className="flex flex-wrap gap-2 justify-center mb-8">
                  {SZ_LIST.map((n) => (
                    <span
                      key={n}
                      className="px-4 py-1.5 rounded-full text-[.72rem] font-semibold border"
                      style={{
                        background: "rgba(45,158,71,.08)",
                        borderColor: "rgba(45,158,71,.22)",
                        color: "#1a5c2a",
                      }}
                    >
                      🌿 {n}
          ...
          {isSd && (
            <div className="text-center mt-14">
              <div
                className="inline-flex items-center gap-4 px-9 py-5 rounded-[22px] border border-orange-200/50"
                style={{ background: "rgba(245,166,35,.07)" }}
              >
                <span className="text-2xl">🍪</span>
                <div className="text-left">
                  <div className="font-serif font-bold text-[#3d1f00] text-base">
                    More products available on request
                  </div>
                  <div className="text-[.8rem] text-[#9c6644] mt-1">
                    Coconut · Kaju · Jeera · Oreo · Milk · Digestive · Glucose ·
                    Butter Masala &amp; more
                  </div>
                </div>
              </div>
